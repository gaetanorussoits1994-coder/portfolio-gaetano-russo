...
function setupCvConsentModal() {
  ...
  if (!openTrigger || !modal || !cvConsent || !openCvButton || !closeButton) return;

  function updateButtonState() {
    var enabled = cvConsent.checked;
  ...
  cvConsent.addEventListener('change', updateButtonState);
